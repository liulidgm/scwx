...
<div class="backpwd">
	...
	<div class="input_group">
        ...
        <input class="form__input" type="password" v-model="pwd" @blur="verify_pwd()" placeholder="请输入8到20位数字与字母组合">
        <span class="errorMsg" v-if="pwdError">{{pwdError}}</span>
    </div>
	<div class="input_group">
        <span class="icon_pwd"></span>
        <input class="form__input" type="password" v-model="confirmPwd" @blur="confirm_pwd()" placeholder="请确认新密码">
