  ...
  <div id="user_wrapper">
    ...
    <div class="content">
      ...
      <ul class="state_wrapper">
        ...
        <router-link :to="{ path:'/bank',query:{title:'银行卡管理'}}">
          <li>
      ...
      <ul class="user_list_item">
        <!-- <router-link :to="{ path:'/risk',query:{title:'风险测评'}}"> -->
          <li class="border_1px" @click="goRisk()">
            <span><img src="../../assets/user/1@2x.png"/></span>
            <span class="item_title">风险测评</span>
            <span class="icon-arrow"></span>
          </li>
        <!-- </router-link> -->
        <router-link :to="{ path:'/identifyInvest',query:{title:'合格投资人认证'}}">
          <li>
        ...
        <router-link :to="{ path:'/project',query:{title:'我的项目'}}">
          <li class="border_1px">
      ...
      <ul class="user_list_item">
        <router-link :to="{ path:'/message',query:{title:'消息中心'}}">
          <li class="border_1px">
        ...
        <router-link :to="{ path:'/invite',query:{title:'我的邀请'}}">
          <li>
        ...
        <router-link :to="{ path:'/backMessage',query:{title:'意见反馈'}}">
          <li>
      ...
      <div class="services">
        <span>客服电话：</span>
        <span class="tel">4001-021-400</span>
      </div>
  ...
  export default {
    ...
    methods: {
      goRisk(){
        ...
        if(this.UserStateInfos.investorFlag=="1"){
  ...
  #user_wrapper{
    ...
    .user_header_wrapper{
      ...
      .icons{
        ...
        width: 0.8rem;
        height: 1rem;
        background: url("../../assets/icons/list-right-arrow.png") no-repeat center;
        background-size: 100%;
        color: #fff;
        font-size: 0.55rem;
        line-height: 1.4rem;
