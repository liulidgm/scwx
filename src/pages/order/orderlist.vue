      ...
      <div id="popup_confirm" class="popup" v-show="isShowPopupConfirm">
          <div class="p_contant">
            ...
            <div class="form-group">
              <input type="number" v-model="code" @blur="verifyCode()" maxlength="6" placeholder="请输入手机验证码">
...
<script type="text/ecmascript-6">
  ...
  import {timer,Encrypt} from '@/config/utils'
  ...
  export default {
    ...
    methods:{
      ...
      confirmCancel(proCode,tenderId){
        this.openLoading();
