        ...
        <div class="item_list needsClick" v-for="item in userTenders">
            <div class="item_title_container needsClick">
              ...
              <span v-if="item.tenderStatusName=='待支付'" class="status needsClick">
                 <count-down :endTime="item.remainingTime" :callback="callback" endText="已经结束了"></count-down>
            ...
            <div class="item_info needsClick">
              ...
              <div class="item_right needsClick">
                ...
                <div class="account_done needsClick">
                  <span class="_status yr">{{item.productStatusName}}</span>
            ...
            <div class="btn_box needsClick">
              ...
              <!--待支付-->
              <div v-if="item.tenderStatusName=='待支付'">
              ...
              <!--订单关闭-->
              <div v-else-if="item.tenderStatusName=='订单关闭'" class="detail_btn" @click="delOrder(item.oidTenderID)">删除</div>

              <!--支付成功-->
              <div v-else-if="item.tenderStatusName=='支付成功'"class="detail_btn" >
              ...
              <div v-else-if="item.tenderStatusName=='购买成功'" class="detail_btn" @click="goNext('订单详情','/orderdetail?oidTenderID='+item.oidTenderID)">查看详情</div>

              <!--其他状态显示‘查看详情’按钮-->
              <div v-else class="detail_btn" @click="goNext('订单详情','/orderdetail?oidTenderID='+item.oidTenderID)">查看详情</div>
