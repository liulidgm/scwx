  ...
  <div id="register_wrapper">
    ...
    <section>
      <div class="input_group">
        ...
        <input class="form__input" type="password" id="pwd" v-model="password" @keyup="verify_pwd()" placeholder="密码必须是8到20位字母数字组合">
    ...
    <button  class="btn_disabled" :class="btn_state_change(code,password)" @click="submit();" style="margin-top:1rem">下一步</button>
  </div>
</template>
    ...
    methods: {
      ...
      btn_state_change(code,pwd){
        ...
        console.log(isHight(arr));
      	if(isHight(arr)&&this.isAgree&&isSuccess([this.codeError,this.pwdError])){
      		return 'btn_default'
      	}
      	return ''
      },
      submit(){
      	var arr = [this.codeError,this.pwdError];
