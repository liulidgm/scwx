  ...
  <div class="purchase_wrapper">
    <div class="init_order_wrapper">
      ...
      <div class="itmes_info">
        ...
        <div>起投金额 <span>{{initOrderData.minAmount}}</span></div>
        <div>最小追投 <span>{{initOrderData.addAmount}}</span></div>
      </div>
    </div>
    ...
    <div class="account_infos">
      ...
      <div>
        ...
        <input type="text" class="moneyInput" :value="purchaseMoney" @blur="checkAmount();"/>
    ...
    <div class="check_wrapper">
      <Checkbox :isAgree="isAgree" @changeInfo="changeInfo" >
      <!--<span slot="agree">-->
        <!--我已阅读并同意<a>《融资计划书》</a>-->
      <!--</span>-->
      </Checkbox>
